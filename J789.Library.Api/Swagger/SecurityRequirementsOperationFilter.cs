...
namespace J789.Library.Api.Swagger
{
    ...
    {
        /// <summary>
        /// Applies the this filter on swagger documentation generation when Authorize is set as the global filter
        /// </summary>
        ...
        public void Apply(OpenApiOperation operation, OperationFilterContext context)
        {
            ...
            // assumes global Authorize filter set
            if ((!anonMethodScope?.Any() ?? false) && (!anonControllerScope?.Any() ?? false))
            {
